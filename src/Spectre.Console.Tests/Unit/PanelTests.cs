...
namespace Spectre.Console.Tests.Unit
{
    ...
    public sealed class PanelTests
    {
        ...
        {
            // Given
            var console = FakeConsole.Create(width: 80);
        ...
        {
            // Given
            var console = FakeConsole.Create(width: 10);
        ...
        {
            // Given
            var console = FakeConsole.Create(width: 25);
        ...
        {
            // Given
            var console = FakeConsole.Create(width: 84);
